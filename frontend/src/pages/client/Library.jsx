...
const Library = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        const [docsRes, catsRes] = await Promise.all([
          getMyDocumentsApi("approved,pending", pageSize, currentPage),
          getCategoriesApi(),
        ]);
  ...
  return (
    <main className="flex-1 min-h-full bg-[#f9fafb] dark:bg-background-dark flex flex-col">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span
                        className="px-2 py-0.5 rounded text-[10px] font-bold bg-gray-50 text-gray-500 dark:bg-gray-800 dark:text-gray-400 border border-gray-100 dark:border-gray-700 max-w-[100px] truncate"
                        title={doc.fileType?.toUpperCase()}
                      >
