              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                ...
                <div className="group bg-white dark:bg-[#1a202c] rounded-2xl border border-gray-200 dark:border-gray-800 p-4 shadow-sm hover:shadow-md transition-all cursor-pointer flex flex-col gap-3">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 line-clamp-2">
                      Comprehensive notes covering supply and demand,
                      elasticity, and market structures. Perfect for finals.
                    </p>
                  </div>
                ...
                <div className="group bg-white dark:bg-[#1a202c] rounded-2xl border border-gray-200 dark:border-gray-800 p-4 shadow-sm hover:shadow-md transition-all cursor-pointer flex flex-col gap-3">
                  <div className="relative w-full aspect-video rounded-xl overflow-hidden bg-gray-100 dark:bg-gray-800">
                    ...
                    <div
                      className="w-full h-full bg-cover bg-center transition-transform duration-500 group-hover:scale-105"
                      data-alt="Hexagonal molecular structure graphic"
                      style={{
                        backgroundImage:
                          'url("https://lh3.googleusercontent.com/aida-public/AB6AXuDnJFtvCPzselaPt9qZEiyoRX_F4qZEL0OIMO6wghuGtyqI2VHdA1ha9A9C40MQtpgFpVrXYQQ5BUVhsPr3Q-jiBXMo8kRgZ2IDhgTjt2yh56P_UAFDPqsFqy4aqiTlLhk8ttpGeHKmbQg197Dik0XOkKAg0Ry6PXmDYW4gNsDaWxrsZbrGoNJArRcBk56oZ0EcL7xUiFXt3t47CPtrhR_DCtSmH5PshR51BH-ZXYzVRhtzj6vR9J0hrMVp6c73ZzENKJu47-HiV1M")',
                      }}
                    ></div>
                  </div>
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 line-clamp-2">
                      Key reactions, mechanisms, and nomenclature rules
                      summarized in 5 pages.
                    </p>
                  </div>
                  <div className="flex items-center justify-between mt-auto pt-2 border-t border-gray-100 dark:border-gray-800">
                    <div className="flex items-center gap-2">
                      <div
                        ...
                        style={{
                          backgroundImage:
                            'url("https://lh3.googleusercontent.com/aida-public/AB6AXuByCcKhbKxVyy4UN3WhicQDaCi4z0QzbwCjIG1KJEqwbZ4FcBM07HYwTC0C7XsglpgIQUPiZ8xLlf3h7z3E4A71bxdG6BF9Cuoh5BOZjIbL_qXzPcHF5MnPGfC8BMrVw2_rJwnF5MbBofDOugBDn50UcU1xENWabN9pVf4_ZeI7Qncc677WOsy5vByoVyRD19DvkW0BW0MY8ILF3MNnLVeE--7wMP5QXq_7LJasXiRq8SYAAF76HUL92gMMScuxaEro1YOs_VNA7AE")',
                        }}
                      ></div>
                      <span className="text-xs font-medium text-gray-600 dark:text-gray-300">
                        David L.
                ...
                <div className="group bg-white dark:bg-[#1a202c] rounded-2xl border border-gray-200 dark:border-gray-800 p-4 shadow-sm hover:shadow-md transition-all cursor-pointer flex flex-col gap-3">
                  <div className="relative w-full aspect-video rounded-xl overflow-hidden bg-gray-100 dark:bg-gray-800">
                    ...
                    <div
                      className="w-full h-full bg-cover bg-center transition-transform duration-500 group-hover:scale-105"
                      data-alt="Vintage map background for history subject"
                      style={{
                        backgroundImage:
                          'url("https://lh3.googleusercontent.com/aida-public/AB6AXuDpwV0BCH25a-vyfFzeKnnt5q5aphxcsQeucTGT3bE6TfwuwzNbb5cymlDi3mZf1DbuSgzI7OaacGx1joptFANJNQPWuNjPiqtARHky915uExC5csnI6e2BvkwuMqPenYZLefubpxD6L0RHkhbs5kN3r8W7jE_kIBXQ1-3VYVIUCbnuGGqhuiyYWzqjUfN90Ui4-hKk3ypxtgyC2beHdL6ES4FVhHAhavChIKd8-ITLYA2vpPdI3-MvTNyi5Ow77e2ar9z9h3Boeio")',
                      }}
                    ></div>
                  </div>
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 line-clamp-2">
                      Detailed timeline and analysis of major global events in
                  ...
                  <div className="flex items-center justify-between mt-auto pt-2 border-t border-gray-100 dark:border-gray-800">
                    <div className="flex items-center gap-2">
                      <div
                        ...
                        style={{
                          backgroundImage:
                            'url("https://lh3.googleusercontent.com/aida-public/AB6AXuCLVPiZffXI3y2aw8CadRLBycudHV9WLuWGMFmXcyf07LsmY5OcC13_uYYSPUtCuLOVUAaLYeJEIglvvnz88f4qhBcAYOc4PZlkiO8WI79vkwVV1H74xPjugsqGJBBkCQIkTWBo0NejPLXY2yyVT4HoWr7yf81REEWr2S1TxA121UBWxw060-utAwUtcD3nTHkljUN6qFFcbpnyHGct5oigPuUPnUsEB8OtjOoOy-bW3TulC8aydiN_AzO0g8Rz-5zSwXOOpayvX-s")',
                        }}
                      ></div>
                      <span className="text-xs font-medium text-gray-600 dark:text-gray-300">
                        Emma W.
